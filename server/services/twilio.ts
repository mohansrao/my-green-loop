...
const config = {
  ...
  twilio: {
    ...
    // A2P 10DLC Messaging Service Configuration (required for delivery)
    messagingServiceSid: process.env.TWILIO_MESSAGING_SERVICE_SID || 'MG8fe748edb797bd2899b19e0a005f7447',
  }
};
...
export async function sendOrderNotification(
  ...
  for (const recipient of recipients) {
    ...
    const messageOptions = {
      ...
      body: messageBody,
      // Include Messaging Service SID for A2P 10DLC compliance
